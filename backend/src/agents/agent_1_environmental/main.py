...
from backend.src.agents.agent_1_environmental.models import (
    ...
    HealthCheckResponse, MonitoringStatus, WeatherData
)
...
from backend.src.agents.agent_1_environmental.spatial_analyzer import PostGISSpatialAnalyzer
from backend.src.agents.agent_1_environmental.predictor import (
    FloodRiskPredictor,
    AlertGenerator,
...
class EnvironmentalIntelligenceAgent:
    ...
    def _create_default_zones(self) -> List[SentinelZone]:
        ...
        return [
            ...
            SentinelZone(
                name="Gowainghat",
                center=GeoPoint(latitude=25.1000, longitude=92.0167),
                radius_km=5.5,
                risk_level=SeverityLevel.CRITICAL,
            ...
            SentinelZone(
                name="Companiganj",
                center=GeoPoint(latitude=25.0333, longitude=91.6333),
                radius_km=5.0,
                risk_level=SeverityLevel.CRITICAL,
            ...
            SentinelZone(
                name="Kanaighat",
                center=GeoPoint(latitude=24.9667, longitude=92.2667),
                radius_km=5.0,
                risk_level=SeverityLevel.CRITICAL,
            ...
            SentinelZone(
                name="Jaintiapur",
                center=GeoPoint(latitude=25.1333, longitude=92.1500),
                radius_km=4.5,
            ...
            SentinelZone(
                name="Beanibazar",
                center=GeoPoint(latitude=24.7500, longitude=92.0167),
                radius_km=4.5,
                risk_level=SeverityLevel.HIGH,
            ...
            SentinelZone(
                name="Zakiganj",
                center=GeoPoint(latitude=24.6000, longitude=92.0333),
                radius_km=4.5,
                risk_level=SeverityLevel.HIGH,
            ...
            SentinelZone(
                name="Fenchuganj",
                center=GeoPoint(latitude=24.7167, longitude=91.8667),
                radius_km=5.0,
                risk_level=SeverityLevel.HIGH,
            ...
            SentinelZone(
                name="Golapganj",
                center=GeoPoint(latitude=24.8000, longitude=92.0000),
                radius_km=4.0,
            ...
            SentinelZone(
                name="Balaganj",
                center=GeoPoint(latitude=24.7667, longitude=91.9000),
                radius_km=4.0,
                risk_level=SeverityLevel.MODERATE,
            ...
            SentinelZone(
                name="Bishwanath",
                center=GeoPoint(latitude=24.8667, longitude=91.6500),
                radius_km=4.0,
                risk_level=SeverityLevel.MODERATE,
            ...
            SentinelZone(
                name="Osmaninagar",
                center=GeoPoint(latitude=24.8333, longitude=91.7833),
                radius_km=3.5,
            ...
            SentinelZone(
                name="Dakshinsurma",
                center=GeoPoint(latitude=24.8500, longitude=91.8200),
                radius_km=3.5,
                risk_level=SeverityLevel.LOW,
                population_density=22000,
                elevation=7.5,
