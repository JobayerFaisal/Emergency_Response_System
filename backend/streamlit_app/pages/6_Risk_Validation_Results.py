...
st.title("🛡️ AI Risk Validation Results")
...
for v in validations:
    with st.container(border=True):
        ...
        st.markdown(f"### 🧾 Report ID: `{v['report_id']}`")
        st.write(f"📅 Validated At: {v['created_at']}")
        ...
        st.markdown("### 🚨 AI Flood Risk Assessment (Agent 1)")
